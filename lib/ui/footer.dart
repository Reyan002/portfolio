...
class Footer extends StatelessWidget {
  ...
  final String _description =
      "I am a professional Mobile App Developer having more than 3 years of experience in Mobile app development Using Platforms Flutter Android Native.";
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  'Proudly powered by Reyan ©${DateTime.now().year}',
                  style: TextStyle(
                    color: AppColors.greyLight!.withOpacity(.75),
                  ),
                ),
